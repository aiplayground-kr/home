  ...
  return <main>
    ...
    <section className="hero hero-v2">
          ...
          <article className="hero-play-console">
            ...
            <div className="hero-console-body">
              ...
              <div className="hero-console-screen">
                <div className="hero-screen-meta"><strong>NOW PLAYING</strong><time dateTime="2026-08-26">2026.08.26</time></div>
                <a href="/small-playground/3" className="hero-screen-event">
                  <img src="/small-playground/03-copilot-homepage.jpg" alt="작은 놀이터 #03 Copilot 홈페이지 만들기 포스터" />
                  <div><span>SMALL #03</span><strong>Copilot으로<br />홈페이지 만들기</strong><small>게임 시작하기 →</small></div>
                </a>
              </div>
      ...
      <div className="hero-now-strip" aria-label="다가오는 AI놀이터 일정">
        ...
        <a href="/small-playground/3"><time>08.26 WED</time><strong>작은 놀이터 #03</strong><span>Copilot 홈페이지 만들기</span></a>
        ...
        <a href="/small-playground/4"><time>09.12 SAT</time><strong>작은 놀이터 #04</strong><span>나만의 에이전트 만들기</span></a>
      </div>
    </section>
