...
export default function SeasonsPage() { return <main><SiteHeader />
  ...
  <section className="hub-grid section-pad compact">
    <a className="hub-card season2" href="/seasons/season-2"><span>NOW PLAYING</span><b>02</b><h2>Season 2</h2><p>BUILD에서 Snowflake로. 배우고 연결하고 실제로 만드는 현재의 시즌.</p><ul>{seasonTwoEvents.map(e => <li key={e.slug}>{e.eyebrow.replace("OFFICIAL EVENT · ", "")} <small>{e.state}</small></li>)}</ul><strong>시즌 2 열기</strong></a>
    <a className="hub-card season1" href="/seasons/season-1"><span>ARCHIVE</span><b>01</b><h2>Season 1</h2><p>Ignite부터 슬기로운 AI 생활까지 네 번의 공식 만남을 게시판으로 기록합니다.</p><ul>{seasonOneEvents.map(e => <li key={e.slug}>{e.title}</li>)}</ul><strong>시즌 1 열기</strong></a>
  </section>
