...
export const snowflakeSessions = [
  ...
  { no: "03", time: "11:00–12:30", topic: "Power Platform / P.P", speaker: "이재석", role: "Microsoft MVP", crew: ["김성미"], description: "Power Platform을 활용한 자동화와 실제 업무 시나리오를 만납니다.", image: "/events/season-2/build/archive/33.png", imageCrop: { left: "-446px", top: "-92px" }, linkedin: "https://www.linkedin.com/in/leejaeseok/" },
