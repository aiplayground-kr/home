...
export const smallPlaygroundPrograms: SmallPlaygroundProgram[] = [
  ...
  },
  {
    ...
    time: "업데이트 예정",
    venue: "업데이트 예정",
    title: "바이브 코딩으로, 나만의 앱 만들기",
    shortTitle: "나만의 앱 만들기",
    description: "코드를 모두 알지 못해도 AI와 대화하며 아이디어를 작은 앱으로 구현해보는 바이브 코딩 프로그램입니다.",
    audience: "바이브 코딩과 앱 제작을 처음 시작해보고 싶은 사람",
    capacity: "업데이트 예정",
    format: "실습형 프로그램 예정",
    duration: "업데이트 예정",
    topics: ["만들고 싶은 문제 정하기", "AI와 기능을 작은 단위로 구현하기", "실행하고 고치며 결과물 완성하기"],
    note: "자료에 확정되지 않은 세부 일정과 모집 정보는 추후 업데이트됩니다.",
  },
  {
    slug: "5",
    number: "#05",
