...
export const smallPlaygroundPrograms: SmallPlaygroundProgram[] = [
  ...
  },
  {
    ...
    time: "오후 3:00–5:00",
    venue: "한국마이크로소프트 13층",
    title: "GitHub Copilot Dev Days: 스페이스 인베이더 게임 만들며 배우는 GitHub Copilot 앱",
    shortTitle: "스페이스 인베이더 × GitHub Copilot",
    description: "GitHub Copilot과 함께 스페이스 인베이더 게임을 직접 만들며 Instructions부터 MCP Server까지 익히는 2시간 핸즈온입니다.",
    audience: "GitHub Copilot으로 직접 앱을 만들고 확장해보고 싶은 사람",
    capacity: "업데이트 예정",
    format: "GitHub Copilot 앱 핸즈온",
    duration: "2시간",
    topics: ["Instructions로 게임 규칙과 개발 방향 설정하기", "GitHub Copilot으로 스페이스 인베이더 게임 만들기", "MCP Server를 연결해 앱 확장하기"],
    note: "허석 Microsoft MVP가 Instructions부터 MCP Server까지 2시간 핸즈온을 진행합니다.",
    image: "/small-playground/04-space-invaders.webp",
    speakers: [{
      name: "허석",
      role: "Microsoft MVP",
      description: "스페이스 인베이더 게임을 만들며 GitHub Copilot 앱 개발과 MCP Server 연결을 안내합니다.",
      image: "/team/huh-seok.jpg",
      linkedin: "https://www.linkedin.com/in/somissem/",
    }],
  },
  {
    slug: "5",
